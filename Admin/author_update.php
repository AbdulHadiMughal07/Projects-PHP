                                    ...
                                    <form method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="text" value="<?php echo $rows['author_name'] ?>" name="authorname" class="form-control" placeholder="Enter Your Author Name">
                                            </div>
                                            <div class="form-group col-md-12">
                                                <label>Date Of Birth</label>
                                                <input type="date" value="<?php echo $rows['dob'] ?>" name="dob" class="form-control" placeholder="Enter Your Date Of Birth">
                                            </div>
                                            <div class="form-group col-md-12">
