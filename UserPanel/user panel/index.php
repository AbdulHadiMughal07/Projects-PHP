        ...
        color: white;
                    ...
                    <div id="main">
                        ...
                        <div class="inner">
                            ...
                            <p class="text-center"><a href="./all_category.php">More Books &nbsp;<i class="fa fa-long-arrow-right"></i></a></p>
                            ...
                            <?php
                                ...
                                <article class="style1">
                                    <span class="image">
                                    <?php 
                                                    echo "<img src=\"../../Admin/images/authorImage{$rows['image']}\"
                                                    height=300px width=300px"
                                                    ?>
                            ...
                            <p class="text-center"><a href="./all_authors.php">More Books &nbsp;<i class="fa fa-long-arrow-right"></i></a></p>
